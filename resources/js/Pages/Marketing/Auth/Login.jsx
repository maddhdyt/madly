...
import { Check, Megaphone, Star, ArrowLeft, Eye, EyeOff } from 'lucide-react';
                ...
                <div className="flex-1 space-y-8 w-full">
                    ...
                    <div>
                        <h1 className="text-4xl lg:text-[44px] font-black text-gray-900 dark:text-white tracking-tight leading-[1.1]">
                            {t('Welcome to')}<br/><span className="font-display tracking-normal text-5xl lg:text-[52px]">{companyName}</span> Marketing!
                        </h1>
                    ...
                    <form onSubmit={submit} className="space-y-5">
                        <div>
                            ...
                            <input
                                ...
                                placeholder="Ex: marketing@zeasy.com"
                            />
