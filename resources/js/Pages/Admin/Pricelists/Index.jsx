    ...
    return (
        <div className="flex flex-col h-full w-full bg-white dark:bg-gray-900 rounded-3xl border border-gray-200 dark:border-gray-800 shadow-sm overflow-hidden transition-colors duration-300">
            ...
            <div className="flex items-center justify-between px-8 py-8 border-b border-gray-100 dark:border-gray-800">
                <div>
                    <h1 className="text-2xl font-bold text-gray-900 dark:text-white tracking-tight">Pricelist Catalog</h1>
                    <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Manage quotation formats and selling prices.</p>
                </div>
                ...
                <table className="w-full text-left text-sm text-gray-600 dark:text-gray-300">
                    <thead className="bg-gray-50/50 dark:bg-gray-800/50 text-gray-500 dark:text-gray-400 text-xs uppercase tracking-wider font-bold border-b border-gray-200 dark:border-gray-800">
                        <tr>
                            ...
                            <th className="px-8 py-4">Pricelist Name</th>
                            <th className="px-8 py-4">Items / Packages</th>
                        ...
                        {pricelists.length === 0 ? (
                            ...
                            pricelists.map((pricelist) => (
                                <tr key={pricelist.id} className="hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors group">
                                    ...
                                    <td className="px-8 py-4 font-bold text-gray-900 dark:text-white">{pricelist.name}</td>
                                    <td className="px-8 py-4 font-medium">{pricelist.prices?.length || 0} packages</td>
