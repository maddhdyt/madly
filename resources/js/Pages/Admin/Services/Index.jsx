        ...
        <MainLayout title="Service Types">
            ...
            <div className="flex flex-col h-full w-full bg-white rounded-3xl border border-gray-200 shadow-sm overflow-hidden">
                ...
                <div className="flex items-center justify-between px-8 py-8 border-b border-gray-100">
                    <div>
                        <h1 className="text-2xl font-bold text-gray-900 tracking-tight">Service Types</h1>
                ...
                <div className="flex-1 overflow-y-auto bg-white p-8">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {services.map((service) => (
                            <div key={service.id} className="border border-gray-200 rounded-2xl p-6 flex flex-col hover:border-gray-300 hover:shadow-md transition-all group bg-white">
                                <div className="flex items-start justify-between mb-4">
                                    <div className="w-12 h-12 rounded-xl bg-gray-100 text-gray-800 flex items-center justify-center">
                                ...
                                <div className="pt-4 border-t border-gray-100 flex items-center gap-2 text-xs font-bold text-gray-400">
                                    <span className="bg-gray-100 px-2.5 py-1 rounded-md text-gray-600">ID: {service.id}</span>
                                    <span>•</span>
                    ...
                    {services.length === 0 && (
                        <div className="flex flex-col items-center justify-center py-20 text-center">
                            ...
                            <h3 className="text-lg font-bold text-gray-900">No service types found</h3>
                            <p className="text-gray-500 mt-2">Create your first service type to start selling.</p>
                        </div>
                    )}
                </div>
            </div>
